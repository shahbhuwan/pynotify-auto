...
def _ping_on_exit():
    ...
    mode = _get_config("mode", "both").lower() # sound, popup, both
    
    # Validation logic
    # - Run time > threshold
    # - Must be a script (sys.argv[0] is set and not interactive)
    # - Not in a specialized environment like IPython/Jupyter unless specified
